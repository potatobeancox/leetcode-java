package com.potato.study.leetcodecn.p00649.t001;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String input = "DDRRRR";
        String s = solution.predictPartyVictory(input);
        System.out.println(s);
        Assert.assertEquals("Radiant", s);

        input = "RD";
        s = solution.predictPartyVictory(input);
        System.out.println(s);
        Assert.assertEquals("Radiant", s);
    }
}
