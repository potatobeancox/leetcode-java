package com.potato.study.leetcodecn.p01279.t001;
...
public class TrafficLight {
    ...
    private boolean road1Green;
    private boolean road2Green;
    private Semaphore semaphore;
    /**
     * https://leetcode.cn/problems/traffic-light-controlled-intersection/solution/java-xin-hao-liang-si-lu-by-wo-huo-xi-jue/
     */
    public TrafficLight() {
        this.road1Green = true;
        this.road2Green = false;
    ...
    public void carArrived(
        ...
        try {
            ...
            // 当前id 一直就通行 否则变灯
            if ((roadId == 1 && road1Green) || (roadId == 2 && road2Green)) {
                crossCar.run();
            } else if (roadId == 1) {
                turnGreen.run();
                road1Green = true;
