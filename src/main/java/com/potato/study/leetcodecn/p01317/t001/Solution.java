package com.potato.study.leetcodecn.p01317.t001;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int n = 2;
        int[] noZeroIntegers = solution.getNoZeroIntegers(n);
        System.out.println(Arrays.toString(noZeroIntegers));


        n = 1010;
        noZeroIntegers = solution.getNoZeroIntegers(n);
        System.out.println(Arrays.toString(noZeroIntegers));
    }
