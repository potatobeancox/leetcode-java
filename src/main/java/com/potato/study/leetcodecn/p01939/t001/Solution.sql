...
-- <> 运算符
-- https://blog.csdn.net/lihanhan98/article/details/121192170

-- timestampdiff 函数
-- https://blog.csdn.net/Hudas/article/details/124351790
...
and TIMESTAMPDIFF(SECOND,c1.time_stamp, c2.time_stamp) BETWEEN 1 and 24 * 3600
