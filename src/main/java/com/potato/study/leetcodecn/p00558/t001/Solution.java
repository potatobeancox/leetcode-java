package com.potato.study.leetcodecn.p00558.t001;
...
public class Solution {
    ...
    public Node intersect(Node quadTree1, Node quadTree2) {
        // 终止条件 如果 当前 quadTree1 或者 quadTree2 有一个已经是孩子了 那么就看看 怎么返回
        if (quadTree1.isLeaf) {
            if (quadTree1.val) {
                return quadTree1;
            } else {
        ...
        // 判断当前 结果
        if (quadTree1.bottomLeft.isLeaf && quadTree1.bottomRight.isLeaf
                ...
                && quadTree1.bottomLeft.val == quadTree1.topRight.val) {
    ...
    public static void main(String[] args) {
        ...
        quadTree1.topLeft = new Node(true, false);
        quadTree1.topRight = new Node(true, false);
        quadTree1.bottomLeft = new Node(true, true);
        quadTree1.bottomRight = new Node(true, true);
        ...
        quadTree2.topRight = new Node(true, true);
        quadTree2.bottomLeft = new Node(true, false);
        quadTree2.bottomRight = new Node(true, true);


        Node intersect = solution.intersect(quadTree1, quadTree2);
