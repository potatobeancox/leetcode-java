package com.potato.study.leetcodecn.p02043.t001;
 ...
 * 2043. 简易银行系统
 *
 * 的任务是为一个很受欢迎的银行设计一款程序，以自动化执行所有传入的交易（转账，存款和取款）。银行共有 n 个账户，编号从 1 到 n 。每个账号的初始余额存储在一个下标从 0 开始的整数数组 balance 中，其中第 (i +
 * 1) 个账户的初始余额是 balance[i] 。
 *
 ...
 * boolean transfer(int account1, int account2, long money) 从编号为 account1 的账户向编号为 account2 的账户转帐 money 美元。如果交易成功，返回
 * true ，否则，返回 false 。
...
public class Bank {
    ...
    /**
     * 从编号为 account1 的账户向编号为 account2 的账户转帐 money 美元。如果交易成功，返回
     *  * true ，否则，返回 false 。
     * @param account1
     * @param account2
     * @param money
