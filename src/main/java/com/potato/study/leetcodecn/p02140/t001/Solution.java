package com.potato.study.leetcodecn.p02140.t001;
...
public class Solution {
    ...
    public long mostPoints(int[][] questions) {
        // dp i 标识 从 i 到n-1获得的最大分数
        int n = questions.length;
        long[] dp = new long[n];
        // dp i = max dpi+1 (i题不做), questions【i】【0】+ dp i +  questions【i】[1] + 1 （到头了就没有了）
        dp[n-1] = questions[n-1][0];
        // 从后往前转移
        for (int i = n-2; i >= 0; i--) {
            long tmp = questions[i][0];
