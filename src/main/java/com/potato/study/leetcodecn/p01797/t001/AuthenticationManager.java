package com.potato.study.leetcodecn.p01797.t001;
...
public class AuthenticationManager {
    ...
    private Map<String, Integer> tokenIdTimeMap;

    public AuthenticationManager(int timeToLive) {
        this.timeToLive = timeToLive;
        this.tokenIdTimeMap = new HashMap<>();
    }
    ...
    public void renew(String tokenId, int currentTime) {
        // 判断是否已经过期
        if (!tokenIdTimeMap.containsKey(tokenId)) {
            return;
        }
