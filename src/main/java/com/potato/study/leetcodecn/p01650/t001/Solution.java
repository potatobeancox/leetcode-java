 ...
 *     public Node parent;
 * }
 * 根据维基百科中对最近公共祖先节点的定义：“两个节点 p 和 q 在二叉树 T 中的最近公共祖先节点是后代节点中既包括 p 又包括 q 的最深节点（我们允许一个节点为自身的一个后代节点）”。一个节点 x 的后代节点是节点 x
 * 到某一叶节点间的路径中的节点 y。
 *
 *  
 *
...
public class Solution {
    ...
    public Node lowestCommonAncestor(Node p, Node q) {
        ...
        // q 往上找父亲 直到在set 中
        parent = q;
        while (parent != null && !parentSet.contains(parent)) {
            parent = parent.parent;
        }
        return parent;
    }
