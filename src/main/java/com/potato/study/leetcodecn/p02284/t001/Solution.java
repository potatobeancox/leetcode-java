package com.potato.study.leetcodecn.p02284.t001;
 ...
 * 示例 1：
 *
 * 输入：messages = ["Hello userTwooo","Hi userThree","Wonderful day Alice","Nice day userThree"], senders = ["Alice",
 * "userTwo","userThree","Alice"]
 * 输出："Alice"
...
public class Solution {
    ...
    public String largestWordCount(String[] messages, String[] senders) {
        ...
        for (int i = 0; i < senders.length; i++) {
            ...
            Integer orDefault = countMap.getOrDefault(name, 0);
            count += orDefault;

            if (count > countMap.getOrDefault(maxKey, 0) ||
                    (count == countMap.getOrDefault(maxKey, 0) && name.compareTo(maxKey) > 0)) {
                maxKey = name;
            }
